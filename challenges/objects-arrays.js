...
*/
const animalNames = [];
zooAnimals.forEach(name => animalNames.push(`Name: ${name.animal_name}, Scientific: ${name.scientific_name}`))
...
*/
const lowerCase = [];
zooAnimals.map(name => lowerCase.push(name.animal_name.toLowerCase())) 
